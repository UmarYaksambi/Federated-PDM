# %% [markdown]
# # Federated Predictive Maintenance — End-to-End Pipeline
...
# 2. Centralised training (E1 — upper bound)
# 3. Federated training — FedAvg, FedProx, Proposed (E2–E4)
# 4. Ablation study (E5)
